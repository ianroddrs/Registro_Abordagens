...
class ModelAtuacao(models.Model):
    id_atuacao = models.AutoField(primary_key=True, unique=True, db_index=True, serialize=True)
    ds_atuacao = models.CharField(max_length=30, null=True, blank=False,choices=ATUACAO)
...
class ModelBop_Pessoa(models.Model):
    id_atuacao = models.ForeignKey(ModelAtuacao,db_column='id_atuacao',related_name='id_atuacao_pc_bp', on_delete=models.CASCADE)
...
class ModelProc_Pessoa(models.Model):
    id_atuacao = models.ForeignKey(ModelAtuacao,db_column='id_atuacao',related_name='id_atuacao_pc_pp', on_delete=models.CASCADE)
